...
class player(object):
    def __init__(self, name: str, id: int, img, car, name__font):
        ...
        self.name_font = font.SysFont("consolas", 28).render(
            self.name+'       '+str(len(self.owned_citys)), True, self.name__font)
...
player1 = player('hgy', 1, load('img/player1.png'),
                 load('img/car1.png'), (148, 20, 252))
player2 = player('hgj', 2, load('img/player2.png'),
                 load('img/car2.png'), (252, 28, 100))
player3 = player('g k', 3, load('img/player3.png'),
                 load('img/car3.png'), (43, 240, 15))
